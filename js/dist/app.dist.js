...
__webpack_require__(/*! ./modules/flickity.min.css */ "./src/modules/flickity.min.css");

var _shuffle = __webpack_require__(/*! ./modules/shuffle */ "./src/modules/shuffle.js");

var _toggleFullscreen = __webpack_require__(/*! ./modules/toggleFullscreen */ "./src/modules/toggleFullscreen.js");

var _flickityBgLazyload = __webpack_require__(/*! flickity-bg-lazyload */ "./node_modules/flickity-bg-lazyload/bg-lazyload.js");

var _flickityBgLazyload2 = _interopRequireDefault(_flickityBgLazyload);

var _flkOptions = __webpack_require__(/*! ./modules/flkOptions */ "./src/modules/flkOptions.js");
...
var photoList = void 0,
    videoList = void 0,
    flkty = void 0;
var photoViewer = document.querySelector('.photoViewer');

var fetchList = function fetchList(resourceType) {
  fetch('data/' + resourceType + '.json').then(function (res) {
    return res.json();
  }).then(function (resString) {
    document.querySelector('.preloader').style.display = "none";
    if (resourceType === "images") {
      photoList = Array.from(resString);
      flkMethods.createFlickityString((0, _shuffle.shuffle)(photoList));
    } else {
...
var flkMethods = {
  createFlickityString: function createFlickityString(fileArray) {
    var innerDiv = "";
  ...
  launchPhotos: function launchPhotos() {
    photoViewer.style.display = "flex";
    setTimeout(function () {
      photoViewer.style.opacity = 1;
    }, 0);
    setTimeout(function () {
      (0, _toggleFullscreen.toggleFullscreen)("on");
    }, 500);
    flkty = new _flickityBgLazyload2.default(".main-carousel", _flkOptions.flkOptions);
    flkty.resize();
  },
  hidePhotoviewer: function hidePhotoviewer() {
    ...
    setTimeout(function () {
      ...
      (0, _toggleFullscreen.toggleFullscreen)("off");
    }, 500);
  },
...
var flkOptions = (_flkOptions = {
  ...
  autoPlay: 5000,
  bgLazyLoad: true
}, _defineProperty(_flkOptions, 'bgLazyLoad', 2), _defineProperty(_flkOptions, 'pauseAutoPlayOnHover', false), _flkOptions);

exports.flkOptions = flkOptions;
...
var shuffle = function shuffle(arra1) {
...
/***/ "./src/modules/toggleFullscreen.js":
/*!*****************************************!*\
  !*** ./src/modules/toggleFullscreen.js ***!
  \*****************************************/
/*! no static exports found */
...
var toggleFullscreen = function toggleFullscreen(option) {
  switch (option) {
    case "on":
